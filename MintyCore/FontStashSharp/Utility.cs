...
namespace MintyCore.FontStashSharp
{
    internal static class Utility
    {
        ...
        public static void BuildTransform(Vector2 position, float rotation, Vector2 origin, Vector2 scale,
            out Matrix transformation)
        {
        ...
        public static void DrawQuad(this IFontStashRenderer2 renderer,
            FontTextureWrapper texture, FSColor color,
            ...
            ref VertexPositionColorTexture bottomLeft, ref VertexPositionColorTexture bottomRight)
        {
            ...
            topRight.Position =
                (baseOffset + new Vector2(size.X, 0)).TransformToVector3(ref transformation, layerDepth);
            topRight.TextureCoordinate = new Vector2((float)textureRectangle.Right / textureSize.X,
                (float)textureRectangle.Y / textureSize.Y);
            topRight.Color = color;

            bottomLeft.Position =
                (baseOffset + new Vector2(0, size.Y)).TransformToVector3(ref transformation, layerDepth);
            ...
            bottomRight.Position =
                (baseOffset + new Vector2(size.X, size.Y)).TransformToVector3(ref transformation, layerDepth);
