...
using Color = MintyCore.FontStashSharp.FSColor;
...
namespace MintyCore.Myra.Graphics2D.UI.ColorPicker
{
	partial class ColorPickerPanel : VerticalStackPanel
	{
		private void BuildUI()
		{
			...
			_hsPicker.HorizontalAlignment = HorizontalAlignment.Center;
			_hsPicker.VerticalAlignment = VerticalAlignment.Center;
			_hsPicker.Enabled = false;
			_hsPicker.Background = new SolidBrush("#FFFFFFFF");
			_hsPicker.Id = "_hsPicker";

			var panel1 = new Panel();
			panel1.HorizontalAlignment = HorizontalAlignment.Left;
			...
			_colorBackground.HorizontalAlignment = HorizontalAlignment.Center;
			_colorBackground.VerticalAlignment = VerticalAlignment.Stretch;
			...
			_colorDisplay.HorizontalAlignment = HorizontalAlignment.Center;
			_colorDisplay.VerticalAlignment = VerticalAlignment.Stretch;
			...
			_saveColor.HorizontalAlignment = HorizontalAlignment.Right;
			...
			StackPanel.SetProportionType(grid1, ProportionType.Fill);
			...
			_userColors.GridSelectionMode = GridSelectionMode.Cell;
