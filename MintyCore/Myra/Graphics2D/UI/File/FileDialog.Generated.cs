...
namespace MintyCore.Myra.Graphics2D.UI.File
{
	partial class FileDialog: Dialog
	{
		private void BuildUI()
		{
			...
			StackPanel.SetProportionType(_textFieldPath, ProportionType.Fill);
			...
			_listPlaces.HorizontalAlignment = HorizontalAlignment.Stretch;
			...
			StackPanel.SetProportionType(_splitPane, ProportionType.Fill);
			...
			StackPanel.SetProportionType(_textFieldFileName, ProportionType.Fill);
