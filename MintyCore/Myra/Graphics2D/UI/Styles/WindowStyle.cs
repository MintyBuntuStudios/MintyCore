namespace MintyCore.Myra.Graphics2D.UI.Styles
{
	public class WindowStyle : WidgetStyle
	{
		...
		{
			TitleStyle = style.TitleStyle is not null ? new LabelStyle(style.TitleStyle) : null;
			CloseButtonStyle = style.CloseButtonStyle is not null ? new ImageButtonStyle(style.CloseButtonStyle) : null;
		}
