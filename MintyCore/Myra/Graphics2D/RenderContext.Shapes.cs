...
namespace MintyCore.Myra.Graphics2D
{
	partial class RenderContext
	{
		...
		public void FillRectangle(Rectangle rectangle, FSColor color) =>
		...
		/// <param name="color">The color to draw the rectangle in</param>
		public void FillRectangle(Vector2 location, Vector2 size, FSColor color) =>
		...
		/// <param name="color">The color to draw the rectangle in</param>
		public void FillRectangle(float x, float y, float width, float height, FSColor color) =>
		...
		public void DrawRectangle(Rectangle rectangle, FSColor color, float thickness = 1f)
		{
		...
		public void DrawRectangle(Vector2 location, Vector2 size, FSColor color, float thickness = 1f)
		{
		...
		/// <param name="thickness">The thickness of the lines</param>
		public void DrawPolygon(Vector2 offset, Vector2[] points, FSColor color, float thickness = 1f)
		{
			if (points.Length == 0)
				return;
		...
		private void DrawPolygonEdge(TextureRegion region, Vector2 point1, Vector2 point2, FSColor color, float thickness)
		{
		...
		/// <param name="color">The color to use</param>
		/// <param name="thickness">The thickness of the line</param>
		public void DrawLine(float x1, float y1, float x2, float y2, FSColor color, float thickness = 1f) =>
		...
		/// <param name="color">The color to use</param>
		/// <param name="thickness">The thickness of the line</param>
		public void DrawLine(Vector2 point1, Vector2 point2, FSColor color, float thickness = 1f)
		{
		...
		/// <param name="color">The color to use</param>
		/// <param name="thickness">The thickness of the line</param>
		public void DrawLine(Vector2 point, float length, float angle, FSColor color, float thickness = 1f)
		{
			var scale = new Vector2(length, thickness);
		...
		/// </summary>
		public void DrawPoint(float x, float y, FSColor color, float size = 1f)
		{
		...
		/// </summary>
		public void DrawPoint(Vector2 position, FSColor color, float size = 1f)
		{
		...
		public void DrawCircle(Vector2 center, float radius, int sides, FSColor color, float thickness = 1f) =>
		...
		/// <param name="color">The color of the circle</param>
		/// <param name="thickness">The thickness of the line</param>
		public void DrawCircle(float x, float y, float radius, int sides, FSColor color, float thickness = 1f) =>
		...
		public void DrawArc(Vector2 center, float radius, int sides, FSColor color, float startAngle, float endAngle, float thickness = 1f) =>
		...
		/// <param name="startAngle">The start angle of the line in radians</param>
		/// <param name="endAngle">The end angle of the line in radians</param>
		public void DrawArc(float x, float y, float radius, int sides, FSColor color, float startAngle, float endAngle, float thickness = 1f) =>
